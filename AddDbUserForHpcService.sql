...
-- ddladmin is needed for SqlBulkCopy operation --
-- or bulkadmin fixed server role should also work, which is too much. We only need it for specific reporting table --
-- see http://msdn.microsoft.com/en-us/library/ms162802.aspx for details --
